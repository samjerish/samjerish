...
def create_terminal_button(name, filename, color_accent, icon_svg_path, direction="left", delay=0.1, text_x="50"):
  ...
  <g class="btn-card">
    ...
    with open(filename, "w", encoding="utf-8") as f:
        f.write(svg)
    print(f"Generated {filename} ({direction} slide)")
...
if __name__ == "__main__":
    ...
    # Slide from Left (Email & LinkedIn)
    create_terminal_button("Email", "email.svg", "#ff7b72", email_path, direction="left", delay=0.1, text_x="54")
    create_terminal_button("LinkedIn", "linkedin.svg", "#58a6ff", linkedin_path, direction="left", delay=0.25, text_x="54")

    # Slide from Right (Instagram & Portfolio)
    create_terminal_button("Instagram", "instagram.svg", "#f0883e", instagram_path, direction="right", delay=0.25, text_x="54")
    create_terminal_button("Portfolio", "portfolio.svg", "#3fb950", portfolio_path, direction="right", delay=0.1, text_x="54")
